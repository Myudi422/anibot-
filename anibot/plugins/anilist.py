...
async def additional_info_btn(client: Client, cq: CallbackQuery, cdata: dict):
    ...
    if kek=='desc':
        ...
        if cq.message.chat.type == "private":
            ...
            btnlist.append(InlineKeyboardButton(text="⌘ Lapor", url=f"https://t.me/otakuindonew"))
        btnlist.append(InlineKeyboardButton(text="⌧ Hapus", callback_data=f'neko_delete, {user}'))
